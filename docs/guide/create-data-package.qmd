---
title: "Creating a new Data Package from the template"
description: |
  How to use this template to create a new Data Package
  or apply the template to an existing Data Package.
order: 1
---
...
- [Git](https://git-scm.com/): For version control and setting up Git to
  track the newly created data package.
...
- The template file `.github/workflows/release-package.yml` requires the
