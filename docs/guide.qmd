...
::: callout-note
To use the `copy` command, the Data Package needs to be tracked by Git and in a clean state (no
changes).
:::
...
Use `update` to apply template updates to your project without overwriting
