...
-   [Python](https://www.python.org/): Required for installing and using
    many of the tools in this template, as well as the fact that the
    template uses Python.
...
You will need install Python and Git yourself, but the other tools can
be installed if you use
