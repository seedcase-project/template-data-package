...
- :recycle: exclude generated files from formatting (#217)

## 0.19.1 (2026-04-23)

### Fix

- :bug: use website in quarto config (#216)

## 0.19.0 (2026-04-23)

### Feat

- :sparkles: set up website in template (#213)

## 0.18.0 (2026-04-13)

### Feat

- :sparkles: integrate Flower (#211)
...
- :arrow_up: updates from `just run-all`, like pre-commit hooks (#209)
